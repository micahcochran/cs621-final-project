...
Vagrant.configure("2") do |config|
  ...
  # As of VirtualBox 6.1.28, host-only network adapters are restricted to IPs in the range 
  # 192.168.56.0/21 by default (192.168.56.1 -> 192.168.63.254).
  # from: https://stackoverflow.com/questions/69722254/vagrant-up-failing-for-virtualbox-provider-with-e-accessdenied-on-host-only-netw
  ...
  config.vm.synced_folder ".", "/home/vagrant/legal_text"
